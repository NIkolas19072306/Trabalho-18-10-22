//Declaração de Variáveis, uso var propositalmente
...
var botao4 = document.querySelector("#limpar")
var dia = []
...
botao3.addEventListener("click", (e) => {
    if (dia.length === 0) {
        saida.innerText = "Vocês concluiu seu dia"
    }
})
//Botão para limpar o Array
